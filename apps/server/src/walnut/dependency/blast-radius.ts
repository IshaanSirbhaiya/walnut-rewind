...
//       since B-012/0eaec9a; artifacts are terminal — the walk never back-propagates from an
...
export function computeBlastRadius(
  ...
  // DERIVED_FROM edges now carry two derived kinds (evidence -> evidence and, since the B-012
