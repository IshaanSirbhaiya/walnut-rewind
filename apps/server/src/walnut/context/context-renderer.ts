...
// Structural-injection hardening (Codex return review B-009 / B-010 item 2): every interpolated
...
//      separators U+2028/U+2029 (B-011: terminals, JavaScript, and model tokenizers treat all
...
// → byte-identical output, spec 003 §A1) is preserved. Proposed to Codex in CHANNEL A-019.
