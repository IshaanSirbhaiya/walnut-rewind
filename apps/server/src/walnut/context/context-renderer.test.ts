// Adversarial tests for the <WALNUT_CONTEXT> structural-injection hardening (B-009 / B-010
...
describe("context-renderer structural-injection hardening (B-009)", () => {
  ...
  it("lone CR and Unicode separators U+2028/U+2029 cannot mint lines either (B-011)", () => {
